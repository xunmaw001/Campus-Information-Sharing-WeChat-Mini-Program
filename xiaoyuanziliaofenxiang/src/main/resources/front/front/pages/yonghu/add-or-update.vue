        ...
        <form class="app-update-pv">
            ...
            <view
                ...
                <view
                    ...
                    <input   disabled
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"16rpx","color":"#f06f4f","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.yonghuJifenNumber" type="number" v-model="ruleForm.yonghuJifenNumber" placeholder="积分"></input>
                </view>
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.yonghuJifenNumber) && (!this.$validate.isIntNumer(this.ruleForm.yonghuJifenNumber)) && this.ruleForm.yonghuJifenNumber >0) {
                    this.$utils.msg(`积分不能为空，不能小于0 格式为数字`);
                    return
                }
                if (this.ruleForm.id) {
