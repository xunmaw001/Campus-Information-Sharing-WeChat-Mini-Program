    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分" prop="yonghuJifenNumber">
                       <el-input v-model="ruleForm.yonghuJifenNumber"
                                 placeholder="积分" clearable  :readonly="ro.yonghuJifenNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="积分" prop="yonghuJifenNumber">
                           <el-input v-model="ruleForm.yonghuJifenNumber"
